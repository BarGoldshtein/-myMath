...
public class Monom implements function {
	...
	public Monom(double a, int b) {
		try {
			if (b < 0) {
				throw new Exception("the power need to be grater than 0");
			} else {
	...
	/**
	 * this function will get an Monom and will multiply it to the Monom who called
	 * it.
	 * 
	...
	/**
	 * this function will get an "x" and return the value of its "y" (we looked upon
	 * the function f as its was an point in graph).
	 * 
	...
	/**
	 * this function will take the Monom and create an new Monom and fill it with
	 * the derivative of the original one.
	 * 
	 * @param der_fx: is a new Monom that we will fill with the derivative of the
	 *        original Monom.
	 ...
	 * 
	 * @param m1:is an Monom that we want to test if he is equals to the Monom who
	 *        called the function.
